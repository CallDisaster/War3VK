...
- 2026-09-20 内存维护候选获用户单轮试玩正向反馈，进入1.22.01修复版收口：动态扩页额度、退役切片复用及Arena渐进缩页，Image/D3D9失败清理与截图按需分配。正式发布状态以[1.22.01说明](docs/RELEASE_1.22.01.md)及开发日志回执为准；不外推跨地图/全GPU/慢磁盘门。
