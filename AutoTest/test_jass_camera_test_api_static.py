...
class JassCameraTestApiStaticTests(unittest.TestCase):
    ...
    def test_life_and_death_route_is_bounded_and_restores_visibility(self) -> None:
        ...
        self.assertIn('desktop_mode == "isolated"', runner)
        self.assertIn('_state_owned_process_alive(target_pid) is True', runner)
        self.assertNotIn('"code": "ISOLATED_DESKTOP_REQUIRED"', runner)
