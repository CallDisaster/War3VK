...
json ToJson(const render::ShadowRuntimeBridgeSummary& summary) {
  ...
  json result = {
      ...
      {"producerSealFrameSerial", summary.producerSealFrameSerial},
      {"producerSealMapEpoch", summary.producerSealMapEpoch},
      {"producerSealDeviceEpoch", summary.producerSealDeviceEpoch},
      ...
      {"producerUvAllocBudgetCount", summary.producerUvAllocBudgetCount},
