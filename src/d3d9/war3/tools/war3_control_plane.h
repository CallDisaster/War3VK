...
struct War3FrameManifestSummary {
  ...
  uint64_t visibleSemanticMergeFallbackCallCount = 0;
  uint64_t visibleSemanticMergeIndexLookupCount = 0;
  uint64_t visibleSemanticMergeIndexHitCount = 0;
  uint64_t visibleSemanticMergeIndexCandidateVisitCount = 0;
  uint64_t visibleSemanticMergeLegacyScanCallCount = 0;
  uint64_t visibleSemanticMergeLegacyScanRecordVisitCount = 0;
  uint64_t visibleSemanticMergeVerifierCallCount = 0;
  uint64_t visibleSemanticMergeVerifierLegacyScanRecordVisitCount = 0;
  uint64_t visibleSemanticMergeVerifierMismatchCount = 0;
  uint64_t visibleSemanticMergeVerifierSelectionMismatchCount = 0;
  uint64_t visibleSemanticMergeVerifierAuxIndexCheckCount = 0;
  uint64_t visibleSemanticMergeVerifierAuxIndexMismatchCount = 0;
  uint64_t visibleSemanticMergeIndexEntryCount = 0;
