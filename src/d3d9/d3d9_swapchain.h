...
namespace dxvk {
  ...
  public:
    ...
    void SetWindowedLogicalSourceExtent(VkExtent2D extent, bool active) {
      m_windowedLogicalSourceExtent = extent;
      m_windowedLogicalSourceActive = active;
    }
    VkExtent2D GetWindowedLogicalSourceExtent() const {
      return m_windowedLogicalSourceExtent;
    }
    bool HasWindowedLogicalSourceExtent() const {
      return m_windowedLogicalSourceActive;
    }
  ...
  private:
    ...
    VkExtent2D                m_windowedLogicalSourceExtent = { 0u, 0u };
    bool                      m_partialCopy = false;
    bool                      m_windowedLogicalSourceActive = false;
